...
router.post("/", common_1.isAuth, express_2.asyncWrapper((req, res) => BudgetAccountController.createAndPostAccount(Object.assign(Object.assign({}, req.body), { userId: req.userId }))
...
router.post("/populate", common_1.isAuth, express_2.asyncWrapper((req, res) => __awaiter(void 0, void 0, void 0, function* () {
