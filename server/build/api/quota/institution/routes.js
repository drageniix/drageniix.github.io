...
router.post(
  ...
  express_2.asyncWrapper((req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      } = yield plaid_1.exchangePlaidPublicToken(req.body.token);
      const {
        itemId,
        institutionName,
        accounts,
      } = yield plaid_1.exchangePlaidAccessTokenForItem(accessToken);
      ...
      return res.status(200).json(
        Object.assign(Object.assign({}, institution.getDisplayFormat()), {
